...
interface Suggestion {
    type: "good" | "improve";
    tip: string;
    explanation?: string; // optional if you don't use it here
}

interface DetailsProps {
    score?: number; // optional so missing data doesn't crash
    suggestions?: Suggestion[]; // optional for safety
}

const Details: React.FC<DetailsProps> = ({ score = 0, suggestions = [] }) => {
    return (
        <div
            className={cn(
